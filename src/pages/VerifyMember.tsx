    ...
    <div className="container mx-auto px-4 py-16 min-h-[70vh]">
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-custom border border-omk-line overflow-hidden">
        ...
        <div className="p-8 flex flex-col items-center text-center">
          {settings ? (
            <div className="w-full flex justify-center bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] bg-gray-50 py-8 px-4 rounded-xl border border-gray-200 overflow-x-auto mb-8">
