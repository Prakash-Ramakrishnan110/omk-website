...
const IDCardTemplate: React.FC<IDCardTemplateProps> = ({ member, settings }) => {
  ...
  return (
    <div className="flex flex-col items-center w-full">
      ...
      <div className="flex justify-center w-full pb-4" style={{ fontFamily: "'Inter', 'Noto Sans Tamil', sans-serif" }}>
        <div className="id-card-wrapper">
          <div ref={cardRef} className="id-card-content bg-[#fcc917] rounded-xl border-[6px] border-white shadow-[0_10px_40px_rgba(0,0,0,0.2)] overflow-hidden box-border">
